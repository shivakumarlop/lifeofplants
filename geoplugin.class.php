...
class geoPlugin {/*this code is downloaded from github*/
	
	//the geoPlugin server
	var $host = 'http://www.geoplugin.net/php.gp?ip={IP}&base_currency={CURRENCY}&lang={LANG}'; /*this is a geo plugin key like weather api */
...
*/
	...
	function locate($ip = null) { /* this is a locate function we call it when we need to get location  how to call check top of index.php file we also need to include this file how to include plz check top of the index.php file or top of the weather.php file  */
		
		global $_SERVER;
		
		if ( is_null( $ip ) ) {
			// $ip = $_SERVER['REMOTE_ADDR']; 
		/* when we are hosting this site on server than comment line 83 static ip and remove comment of line 81 it is userd for getting remote ip  */
			$ip = '120.22.134.179'; /*this is static ip for localhost*/
		}
	...
	function nearby($radius=10, $limit=null) {
		...
		$host = "http://www.geoplugin.net/extras/nearby.gp?lat=" . $this->latitude . "&long=" . $this->longitude . "&radius={$radius}";   /*this is a geo plugin key like weather api key */
